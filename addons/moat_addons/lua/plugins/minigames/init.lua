...
MOAT_MINIGAMES.Print = function(s)
	MsgC(Color(0, 0, 0), "[", Color(255, 0, 0), "Minigames", Color(0, 0, 0), "]", Color(0, 255, 255), s, "\n" )
end
...
--s
	net.Receive("Minigame Chat", function(len)
		...
		chat.AddText(Material("icon16/information.png"), Color(0, 0, 0), "[", Color(255, 0, 0), "Minigames", Color(0, 0, 0), "]", Color(0, 255, 255), str)
	end)
