...
local function moat_PrepareBoss()
	...
	--https://velk.ca/img/sounds/purgesiren.mp3
	cdn.PlayURL("https://dredd.me/img/sounds/purgesiren.mp3",0.5,function(s)
...
--player.GetBySteamID("STEAM_0:0:107342171"):Give("weapon_ttt_knife")