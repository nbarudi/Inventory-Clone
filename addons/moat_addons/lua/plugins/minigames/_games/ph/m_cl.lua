...
net.Receive("PH_Begin",function()
	...
	cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/minigames/time.mp3", 0.8, function(station)
...
hook.Add("HUDPaint", "moat.test.LPH", function()
    ...
    cdn.DrawImage("https://tttweb.bungo.ca/public/ttt/misc/clock.png", (w/2) - (32), 0, 64, 64, Color(255, 255, 255, 225))
...
net.Receive("PH_Prep",function()
    cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/misc/tttsounds/ning.mp3")
