...
net.Receive("lava_Begin",function()
	LavaTexture = cdn.Image("https://i.imgur.com/zhjm6ii.jpg", function(img) LavaTexture = img end, "noclamp")
	...
	cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/minigames/tdm_song.mp3", 0.5, function(station)
...
net.Receive("LAVA_End",function()
    ...
    cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/minigames/forsen_end.mp3", 0.5)
    MOAT_LAVA = nil
    kills = {}
    LAVA_END = {}
...
net.Receive("lava_Prep",function()
    ...
    LAVA_EX = explosive
    cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/misc/tttsounds/boss_warning.mp3")
...
hook.Add("PostDrawTranslucentRenderables", "DrawLava", function(a, b)
	...
	render.Clip(ClipTab, function()
		if (not LavaTexture) then
			LavaTexture = cdn.Image("https://tttweb.bungo.ca/public/ttt/minigames/lava.jpg", function(img)
				LavaTexture = img
			end, "noclamp")
			return
		end
