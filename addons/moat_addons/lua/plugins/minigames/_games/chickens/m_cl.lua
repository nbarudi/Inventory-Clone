...
function MG_CM.PrepRound()
	...
	cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/misc/tttsounds/boss_warning.mp3",0.5,function(s)
...
function MG_CM.PlayMusic(num)
	cdn.PlayURL(table.Random({
		"https://tttweb.bungo.ca/public/ttt/misc/tttsounds/chicken_song1.mp3", 
		"https://tttweb.bungo.ca/public/ttt/misc/tttsounds/chicken_song2.mp3"
	}), 0.4)
end
