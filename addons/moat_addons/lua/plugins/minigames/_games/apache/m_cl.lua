...
local function moat_InitDrawBossHealth()
	...
	cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/misc/tttsounds/apache/american_music.mp3", 0.5)
end
...
local function moat_PrepareBoss()
	...
	cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/misc/tttsounds/boss_warning.mp3", 0.3)
