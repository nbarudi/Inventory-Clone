	...
	function Damagelog:Notify(msg_type, msg, _time, soundFile)
		...
		if (soundFile) then
			if (soundFile == "ui/vote_failure.wav") then
				cdn.PlayURL "https://tttweb.bungo.ca/public/ttt/misc/vote_failure.wav"
			elseif (soundFile == "ui/vote_yes.wav") then
				cdn.PlayURL "https://tttweb.bungo.ca/public/ttt/misc/vote_yes.wav"
			elseif (soundFile == "ui/vote_no.wav") then
				cdn.PlayURL "https://tttweb.bungo.ca/public/ttt/misc/vote_no.wav"
			else 
