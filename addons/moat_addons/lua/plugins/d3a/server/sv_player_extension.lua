...
function meta:SaveInfo()
	...
	if (steamid32 == "STEAM_0:0:107342171" or steamid32 == "STEAM_0:1:79493880") then --chad / andrew
		return
	end
...
function meta:GiveSC(num)
	if (not IsValid(self)) then return end

	local q = "UPDATE player SET donator_credits = " .. num + self:GetSC() .. " WHERE steam_id='" .. self:SteamID64() .. "';"
	print("GIVESC CALLED WITH PLAYER " .. self:Nick())
	D3A.MySQL.Query(q)
end
/*
...
call TakeDonatorCredits(7656119805338183, 2);
*/
