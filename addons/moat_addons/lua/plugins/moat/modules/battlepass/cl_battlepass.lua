...
local crates = {
    "https://tttweb.bungo.ca/public/ttt/misc/alpha_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/beta_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/cosmetic_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/paper_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/crimson_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/effect_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/fiftyfifty_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/hype_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/melee_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/model_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/paint_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/spring_crate64.png",
    "https://tttweb.bungo.ca/public/ttt/misc/titan_crate64.png",
}
...
function make_battlepass()
    ...
    M_BP.Paint = function(s, w, h)
		local tl = util.TimeRemaining(1630511940, os.time())
		local left = string(
...
function m_CreateBattlePanel(pnl_x, pnl_y, pnl_w, pnl_h)
    ...
    M_BATTLE_PNL.Paint = function(s, w, h)
    	...
    	draw.SimpleText("Bungo", "moat_GambleTitle", 5, 1, Color(0, 25, 50))
