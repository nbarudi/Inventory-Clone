...
function check_derma_skin()
	if (file.Exists("gritsky_assets/ui2.png", "DATA")) then
		timer.Remove "moat.load.derma"

		local m = Material("data/gritsky_assets/ui2.png", "noclamp")
	...
	http.Fetch("https://i.imgur.com/tVkttjX.png", function(b)
		file.Write("gritsky_assets/ui2.png", b)
	end)
end
