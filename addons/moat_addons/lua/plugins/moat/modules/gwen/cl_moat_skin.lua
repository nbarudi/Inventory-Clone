...
function check_derma_skin()
	if (file.Exists("bungottt_assets/ui2.png", "DATA")) then
		timer.Remove "moat.load.derma"

		local m = Material("data/bungottt_assets/ui2.png", "noclamp")
	...
	http.Fetch("https://i.imgur.com/tVkttjX.png", function(b)
		file.Write("bungottt_assets/ui2.png", b)
	end)
end
