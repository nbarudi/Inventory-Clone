...
MOAT_DONATE.BackgroundURL = "https://i.imgur.com/wvWuFYH.png"
...
function MOAT_DONATE:DrawRewardsInfo(pnl, pkg, clr)
    ...
    function steam:Paint(w, h)
        ...
        surface.DrawTexturedRect(0, 0, w, 45)
        surface.DrawOutlinedRect(0, 0, w, 45)
        cdn.DrawImageRotated("https://i.imgur.com/vFSCmdq.png", 10, 4, 35, 35, nil, math.sin(CurTime()) * 15, true)
    ...
    function steam:Paint(w, h)
        ...
        surface.DrawTexturedRect(0, 0, w, 45)
        surface.DrawOutlinedRect(0, 0, w, 45)
        cdn.DrawImageRotated("https://dredd.me/img/gritskylogo512.png", 10, 4, 35, 35, nil, math.sin(CurTime() + 10) * 15, true)
    ...
    if not hastag then
        lb:SetText("NOTE: You can only get daily rewards by adding gritsky.gg to your name! Capitalization doesn't matter")
    else
        lb:SetText("You have gritsky.gg in your name and are currently receiving daily rewards!")
    end
...
function MOAT_DONATE:OpenWindow()
    ...
    self.bg.Paint = function(s, w, h)
        ...
        --draw.SimpleText("Gritsky", "moat_GambleTitle", 5, 1, Color(0, 25, 50))
        --draw.SimpleText("Gaming", "moat_GambleTitle", 55, 1, Color(50, 50, 50))
		local w2, h2 = draw.SimpleText("Gritsky", "moat_GambleTitle", 4, 0, Color(0, 198, 255))
    ...
    g.DoClick = function(s)
        gui.OpenURL("https://store.gritskygaming.net")
    end
