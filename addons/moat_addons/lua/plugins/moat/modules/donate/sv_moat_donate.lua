...
MOAT_DONATE.Packages = {
    ...
    [9] = {
        ...
        function(ply)
            ...
            discord.Send("Bungo TTT Announcement", markdown.WrapBold(string(":satellite_orbital::satellite: ", markdown.Bold"Global TTT Announcement", " :satellite::satellite_orbital:", markdown.LineStart(msg))))
...
local function namerewards()
    ...
    local function nametag(ply)
        return ply:Nick():lower():match("bungottt%.gg")
    end
    ...
    net.Receive("NameRewards.Collect", function(l, ply)
        ...
        ply.pendingname = nil
        q:start()
        ply:SendLua("chat.AddText('You have collected your points! Thanks for supporting Bungo Gaming <3')")
    end)
end
