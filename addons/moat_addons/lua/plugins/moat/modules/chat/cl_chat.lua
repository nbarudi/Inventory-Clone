...
moat_chat.chattype = ""
moat_chat.alpha = 0
moat_chat.header = system.IsOSX() and "Bungo Gaming | TTT Testing" or "Bungo Gaming | TTT Testing | More fun @ bungottt.gg"
...
function moat_chat.OpenChat()
    ...
    moat_chat.header = "Bungo Gaming | " .. GetServerName():sub(1, 18) .. (system.IsOSX() and "" or " | bungottt.gg")
    local mc = moat_chat
