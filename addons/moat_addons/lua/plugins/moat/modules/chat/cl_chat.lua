...
moat_chat.chattype = ""
moat_chat.alpha = 0
moat_chat.header = system.IsOSX() and "Gritsky Gaming | TTT Testing" or "Gritsky Gaming | TTT Testing | More fun @ gritskygaming.net"
...
function moat_chat.InitChat()
    ...
    mc.MOVE.Paint = function(s, w, h)
        cdn.DrawImage("https://i.imgur.com/s6Rrz2W.png", 0, 0, w, h, Color(255, 255, 255, (50 + s.HoverColor) * mc.alpha))
    end
...
function moat_chat.OpenChat()
    ...
    moat_chat.header = "Gritsky Gaming | " .. GetServerName():sub(1, 18) .. (system.IsOSX() and "" or " | gritskygaming.net")
    local mc = moat_chat
