...
local moat_Adverts = {
	--{ Color( 255, 255, 0 ), "Visit our forums @ https://tttweb.bungo.ca/" },
	...
	--{ Color( 255, 255, 0 ), "If you would like to support the server through your steam name, please add bungottt.gg to it to receive 25% more IC when deconstructing!" },
