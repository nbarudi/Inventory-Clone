...
local moat_Adverts = {
	{ Color( 255, 255, 0 ), "Visit our forums @ https://gritskygaming.net/" },
	...
	--{ Color( 255, 255, 0 ), "If you would like to support the server through your steam name, please add gritsky.gg to it to receive 25% more IC when deconstructing!" },
	...
	{ Color( 255, 255, 0 ), "Someone causing problems with no staff online? Make a player complaint in our discord." },
