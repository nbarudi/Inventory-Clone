...
function Content:HotMount(wid)
	if (steamworks.IsSubscribed(wid)) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "We're subbed to " .. tostring(wid) .. ".\n")
	...
	steamworks.FileInfo(wid, function(r)
		if (not r) then
			...
			return MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Failed to Hot Load " .. tostring(wid) .. ".\n")
		end
		...
		steamworks.Download(r.fileid, true, function(c)
			...
			MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Hot Loaded " .. tostring(wid) .. ".\n")
		end)
	end)
end
...
MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Init\n")
...
local function prepare(outFile, inf)
	...
	if (not fh) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Unable to open datapack: "..inf.FileName.."\n")
	...
	if (not compressedData) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Unable to read datapack: "..inf.FileName.."\n")
	...
	if (not rawData) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Unable to decompress datapack: "..inf.FileName.."\n")
	...
	if (not fh2) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Unable to open outfile for datapack: "..inf.FileName.."\n")
	...
	MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Cached datapack: "..inf.FileName.." in "..round(time, 4).." seconds\n")
...
local function mount(inf)
	...
	if (not isCached) and (not file.Exists(parent .. inf.File, 'GAME')) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Missing datapack: "..inf.FileName.."\n")
	...
	if (not succ) then
		MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Failing to mount datapack: "..inf.FileName.."\n")
	...
	local time = (SysTime() - start)
	MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Mounted datapack: "..inf.FileName.." in "..round(time, 4).." seconds\n")
...
if (compressedSize > 0) then
	MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Decompressed "..round(compressedSize / 1048576) .. "MB\n")
end

if (decompressedSize > 0) then
	MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Cached "..round(decompressedSize / 1048576) .. "MB\n")
end

MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Loaded "..totalFiles.." files\n")
MsgC(Color(103, 152, 235), "[bungottt] ", Color(255, 105, 180), "Finished in "..round(totalTime, 4).." seconds\n")