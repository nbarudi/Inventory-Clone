...
function m_CreatePaints()
	for k , v in pairs(MOAT_PAINT.Tints) do
        ...
        tbl.PaintVer = 1
        tbl.Image = v[4] or "https://tttweb.bungo.ca/public/ttt/misc/tint.png"
        tbl.ItemCheck = 11
	...
	for k, v in pairs(MOAT_PAINT.Paints) do
        ...
        tbl.Collection = "Paint Collection"
        tbl.PaintVer = 2
        tbl.Image = v[4] or "https://tttweb.bungo.ca/public/ttt/misc/paint.png"
        tbl.ItemCheck = 10
        function tbl:ItemUsed(pl, slot, item)
...
function m_InitializeItems()
	if (SERVER) then
		AddCSLuaFile(MOAT_ITEM_FOLDER .. "/droptable1.lua")
		AddCSLuaFile(MOAT_ITEM_FOLDER .. "/droptable2.lua")
	end

    include(MOAT_ITEM_FOLDER .. "/droptable1.lua")
	include(MOAT_ITEM_FOLDER .. "/droptable2.lua")
