...
function MOAT_LOADOUT.ApplyChaotic(wep)
	local OldDrawWorldModel = wep.DrawWorldModel or wep.DrawWorldModelTranslucent or wep.DrawModel
	...
	function wep:DrawWorldModelTranslucent()
		...
		render.MaterialOverride(propspec_outline)
		render.SuppressEngineLighting(true)
		render.SetColorModulation(rarity_names[10][2].r / 255, rarity_names[10][2].g / 255, rarity_names[10][2].b / 255)
...
function MOAT_LOADOUT.ApplyAngelic(wep)
	local OldDrawWorldModel = wep.DrawWorldModel or wep.DrawWorldModelTranslucent or wep.DrawModel
...
function MOAT_LOADOUT.UpdateWep()
	...
	timer.Create(name, 0.02, 0, function()
		...
		elseif (wep_stats.item and wep_stats.item.Rarity and wep_stats.item.Rarity == 10) then
			MOAT_LOADOUT.ApplyChaotic(wep)
		elseif (wep_stats.item and wep_stats.item.Rarity and wep_stats.item.Rarity == 11) then
			MOAT_LOADOUT.ApplyAngelic(wep)
		end
...
hook.Add("PostDrawViewModel", "Render.Planetary.Effects", function(ent, pl, wpn)
	...
	elseif (wpn.Angelic) then
		...
		wpn.SheetEffect:SetSequence(ent:GetSequence())
		render.MaterialOverride(propspec_outline)
		render.SetColorModulation(rarity_names[11][2].r / 255, rarity_names[11][2].g / 255, rarity_names[11][2].b / 255)
