...
MOAT_EVENT.WeaponsChallenges = {
    ...
    ["weapon_ttt_badger"] = {150, 125, 125, 100, 100, 35, 25, 500},
}
...
function MOAT_EVENT.ChallengeComplete()
	...
	cdn.PlayURL("https://tttweb.bungo.ca/public/ttt/drops/level_up.wav")
end
...
function MOAT_EVENT.RulesPanel(pnl)
	pnl.Paint = function(s, w, h)
		--cdn.DrawImage("https://i.imgur.com/9vXPz7C.png", (w / 2) - (235 / 2), 30, 256, 256, Color(255, 255, 255, 225))

		draw.SimpleTextOutlined("Bungo Official Event Rules", "Trebuchet24", w/2, 20, moat_lyanblue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color( 0, 0, 0, 25 ))
