    ...
    for k, v in ipairs(MOAT_INV_CATS) do
        ...
        MOAT_CAT_BTN.Paint = function(s, w, h)
			 if (s.CatLabel == "Store") then
			 	cdn.DrawImage("https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/twitter/259/dollar-banknote_1f4b5.png", (w/2)-8, (h/2)-8, 16, 16, Color(255, 255, 255, 100 + s.hover_coloral))
...
function m_CreateItemMenu(num, ldt)
	...
	if (string.find(string.lower(LocalPlayer():Nick()), "gritsky.gg")) then
