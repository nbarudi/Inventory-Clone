...
function m_CreateGamblePanel(pnl_x, pnl_y, pnl_w, pnl_h)
    ...
    MOAT_GAMBLE_BG.Paint = function(s, w, h)
		...
		local w2, h2 = draw.SimpleText("Bungo", "moat_GambleTitle", 5, 1, Color(0, 25, 50))
    	draw.SimpleText(" Gaming", "moat_GambleTitle", 5 + w2, 1, Color(50, 50, 50))

    	draw.SimpleText("Bungo", "moat_GambleTitle", 4, 0, Color(0, 198, 255))
...
local bomb_sounds = {
    ...
    ["boom"] = "https://tttweb.bungo.ca/public/ttt/gamble/bomb.mp3",
    ["end"] = "https://tttweb.bungo.ca/public/ttt/gamble/loss.mp3",
	["versus_win"] = "https://tttweb.bungo.ca/public/ttt/gamble/vs_win.mp3",
		...
		for x = 0,4 do
			...
			BTN2.Paint = function(s, w, h)
				...
				elseif mines[s.i] == -1 then
                    ...
                    cdn.DrawImage("https://i.imgur.com/AOwpVs3.png", 0, 0, 64, 64)
				end
				--draw.SimpleText(bombs[i], "Trebuchet24", w/2, h/2, cols[3], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			end
			BTN2.DoClick = function(s, w, h)
...
local fsize = 505, 460
local mats = {
    wheel = "https://i.imgur.com/JflDtIH.png",
    mat_green_normal = "https://i.imgur.com/CgfWG8n.png",
    mat_green_red = "https://i.imgur.com/dYrr48n.png",
    mat_green_black = "https://i.imgur.com/oTaWgjP.png",
    mat_green_normal_hover = "https://i.imgur.com/A8PVzdv.png",
    mat_green_black_hover = "https://i.imgur.com/BDNkdzQ.jpg",
    mat_green_red_hover = "https://i.imgur.com/0zBT5uw.png"
}
...
function m_DrawBlackjackPanel()
	...
	MOAT_GAMBLE_BLACK.Paint = function(s, w, h)
		...
		if not test then
			draw.DrawText("Jackpot is cross-server!","moat_JackVerySmall",w/2,h-18,Color(255,255,255),TEXT_ALIGN_CENTER)
		end
...
local BlackSounds = {
	Place = {
		"https://tttweb.bungo.ca/public/ttt/gamble/18-12-19-44j.mp3",
		"https://tttweb.bungo.ca/public/ttt/gamble/18-12-19-n21.mp3",
		"https://tttweb.bungo.ca/public/ttt/gamble/18-12-19-X1h.mp3",
		"https://tttweb.bungo.ca/public/ttt/gamble/18-12-19-t87.mp3"
	}
}
...
function m_DrawVersusPanel()
    ...
    MOAT_GAMBLE_VS.Paint = function(s, w, h)
		...
		surface.SetDrawColor(86, 86, 86)
		surface.DrawLine(0,h-20,w,h-20)
		draw.DrawText("Versus is cross-server!","moat_JackVerySmall",w/2,h-18,Color(255,255,255),TEXT_ALIGN_CENTER)
    end
...
table.insert(MOAT_GAMBLE.GlobalTable,{Color(255,255,255),"This chat is connected to all of our servers!"})

table.insert(MOAT_GAMBLE.GlobalTable,{Color(255,0,0), "If you need staff on your server or want to meet players, join our Discord"})
