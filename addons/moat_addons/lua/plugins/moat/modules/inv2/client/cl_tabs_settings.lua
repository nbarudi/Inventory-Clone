local moat_convars = {
    ...
    ["moat_mass_deconstruct_rarity"] = "High-End",
    ["moat_fast_open"] = 1,
...
local moat_rarity_colors = {
    ...
    ["Extinct"] = Color(252,134,0),
    ["Planetary"] = Color(22,0,73),
    ["Chaotic"] = Color(150,22,0),
    ["Angelic"] = Color(255,247,213)
}
...
moat_Settings.Options = {
    ...
    {"HUD",
        ...
        {"Disable Item Drop Screen Shake", {"Multi"}, "moat_disable_screenshake"},
    ...
    {"Inventory",
        ...
        {"Max Rarity for Mass Deconstruct", {"MultiText", "Worn", "Standard", "Specialized", "Superior", "High-End", "Ascended", "Cosmic", "Extinct", "Planetary"}, "moat_mass_deconstruct_rarity"},
