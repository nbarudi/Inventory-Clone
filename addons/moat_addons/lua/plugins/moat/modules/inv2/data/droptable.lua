...
function ITEM:OnBeginRound(ply, powerup_mods)
	timer.Simple(2, function()
		...
		if (ply:GetRole() and ply:GetRole() == ROLE_TRAITOR or ply:GetRole() == ROLE_DETECTIVE) then
			local new_credits = GetConVar("ttt_credits_starting"):GetInt() + math.Round( self.Stats[1].min + ( ( self.Stats[1].max - self.Stats[1].min ) * math.min(1, powerup_mods[1]) ) )
...
ITEM.Collection = "Lust Collection"
...
ITEM.Name = "Valentines 2021 Crate"
...
ITEM.Talents = { "Paintball", "*click*", "random" }
m_AddDroppableItem(ITEM, 'Unique')


ITEM = {}
ITEM.ID = 10202
ITEM.Name = "Unprotected"
ITEM.Rarity = 5
ITEM.Collection = "Lust Collection"
ITEM.NameColor = Color(0,191,255)
ITEM.MinStats = 6
...
ITEM.Description = "slut 2.0, but she still doesn't love you :("
...
ITEM = {}
ITEM.ID = 10212
ITEM.Name = "What are you doing, step"
ITEM.Rarity = 7
ITEM.Collection = "Lust Collection"
ITEM.NameColor = Color(0,191,255)
ITEM.MinStats = 7
...
ITEM.MinTalents = 4
ITEM.MaxTalents = 4
ITEM.Talents = {"paintball", "paintball", "paintball", "paintball"}
m_AddDroppableItem(ITEM, 'Unique')
...
ITEM.Name = "Furry Model"

ITEM.Description = "You degenerates, is this what you wanted?"

ITEM.Model = "models/player/alicede_sharkfurry.mdl"
...
ITEM = {}
ITEM.ID = 10217
ITEM.Name = "The Lust Machine"
ITEM.Rarity = 8
ITEM.WeaponClass = "weapon_ttt_scorpion"
ITEM.Collection = "Lust Collection"
ITEM.NameColor = Color(0,191,255)
ITEM.MinStats = 6
ITEM.MaxStats = 7
...
ITEM.Collection = "Beginner Collection"
...
ITEM.Rarity = 6
ITEM.Collection = "Spacey Collection"
ITEM.MinStats = 5
ITEM.MaxStats = 7
ITEM.Stats = {
...
ITEM.Description = "A special item given as a thanks to the sugar daddies of Tera"
...
ITEM.ID = 920
ITEM.Description = "A special effect given to the very dedicated Tera TTT players that reach level 100"
ITEM.Rarity = 8
ITEM.NameColor = Color(0, 191, 255)
...
ITEM.Image = "https://i.imgur.com/0j0ztcG.png"
ITEM.Attachment = "eyes"
...
ITEM.Image = "https://i.imgur.com/A1iVyXf.png"
ITEM.Attachment = "eyes"
...
ITEM.Image = "https://i.imgur.com/KxcEV7n.png"
ITEM.Attachment = "eyes"
...
ITEM.Image = "https://i.imgur.com/JLBV3gW.png"
ITEM.Attachment = "eyes"
...
ITEM.Image = "https://i.imgur.com/p01XsLz.png"
ITEM.Attachment = "eyes"
...
ITEM.Name = "Michael Model"

ITEM.Description = "You forget a thousand things every day, pal. Make sure this is one of 'em."

ITEM.Model = "models/grandtheftauto5/michael.mdl"
...
ITEM.Name = "Captain Rex Model"

ITEM.Description = "“The war left its scars on all of us.”"

ITEM.Model = "models/tera_gg/loudmantis/501/rex.mdl"
...
ITEM.Name = "Captain Kirk Model"

ITEM.Description = "“Beam me up, Scotty.”"

ITEM.Model = "models/startrek/player/kirk/kirk.mdl"
...
ITEM.Name = "Zero Suit Samus Model"

ITEM.Description = "“I got tits.”"

ITEM.Model = "models/player_zsssamusu.mdl"
...
ITEM = {}
ITEM.ID = 362
ITEM.Name = "Energizing VSS"
ITEM.Rarity = 6
ITEM.Collection = "Space Collection"
ITEM.WeaponClass = "weapon_ttt_vss"
ITEM.MinStats = 6
ITEM.MaxStats = 8
ITEM.NameEffect = "electric"
ITEM.Stats = {
...
ITEM = {}
ITEM.ID = 358
ITEM.Name = "Energizing G11"
ITEM.Rarity = 7
ITEM.Collection = "Space Collection"
ITEM.WeaponClass = "weapon_ttt_g11"
ITEM.MinStats = 6
ITEM.MaxStats = 8
ITEM.NameEffect = "electric"
ITEM.Stats = {
...
ITEM.Name = "Clone Assassin Model"

ITEM.Description = "“Earned by playing during launch week and being an AOTR member.”"

ITEM.Model = "models/tera_gg/assassin/trooper/assassin.mdl"
...
ITEM.Collection = "Flower Collection"
...
ITEM = {}
ITEM.ID = 673
ITEM.Name = "Sprouting Scorpion"
ITEM.Rarity = 6
ITEM.WeaponClass = "weapon_ttt_scorpion"
ITEM.Collection = "Flower Collection"
ITEM.NameColor = Color(40,100,0)
ITEM.MinStats = 6
ITEM.MaxStats = 7
ITEM.Stats = {
	Damage = { min = 17, max = 28 },
...
ITEM.MaxTalents = 3
ITEM.Talents = {"random", "random", "random"}
ITEM.WeaponClass = "weapon_ttt_bo2_remington"
m_AddDroppableItem(ITEM, 'Unique')
...
ITEM.ItemUsed = function(pl, slot, item)
	moat_makemvp(pl:SteamID64())
	m_AddCreditsToSteamID(pl:SteamID(), 32000)
end
m_AddDroppableItem(ITEM, 'Usable')
...
ITEM.Name = "Retro Crate"

ITEM.Description = "This crate contains an item from the Retro Collection! Right click to open"

ITEM.Image = "https://noahg.codes/s/noah/060613-NaiveBedbug.png"

ITEM.Rarity = 2

ITEM.Collection = "Retro Collection"
...
ITEM.NewItem = 1617303600 // os.time({year=2021, month=4, day=1})
...
ITEM.Name = "Halo Elite Model"

ITEM.Description = "“Ahhh, lohbaba!”"

ITEM.Model = "models/player/halo3elite.mdl"
...
ITEM.Name = "Big Smoke Model"

ITEM.Description = "“I can't stand cold food. Unlike you, I ain't never ate from a trash can.”"
...
ITEM.Name = "Tommy Vercetti Model"

ITEM.Description = "“Okay, you've proved your point now get lost.”"

ITEM.Model = "models/winningrook/gtavc/hdtommy.mdl"
...
ITEM.WeaponClass = "weapon_esword"
...
ITEM.Name = "Carl Wheezer Model"

ITEM.Description = "“Earned by completing all the compensation requests and bitching and moaning like a little baby girl.”"

ITEM.Model = "models/carlwheezer/playermodels/carlwheezer.mdl"

ITEM.Rarity = 8

ITEM.Collection = "Noah's Super Secret Collection"
