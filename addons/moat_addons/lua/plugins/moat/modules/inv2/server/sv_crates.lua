...
net.ReceiveNoLimit("MOAT_VERIFY_CRATE", function(len, ply)
    ...
    if (fast_open and da_item and da_item.Price) then 
        ...
        //If its the bungottt crate then it'll buff the crate.
        //if(crate_collection == "Bungo Collection") then
        //    tbl2 = buffCrate(crate_collection, 2)
        //if(crate_collection == "YingYang Collection") then
        //    tbl2 = buffCrate(crate_collection, 100)
        //end
...
net.Receive("MOAT_INIT_CRATE", function(len, ply)
    ...
    for i = 1, 100 do
        timer.Simple(i * 0.01, function()
            ...
            if(crate_collection == "Bungo Collection") then
                tbl2 = buffCrate(crate_collection, 2)
            elseif(crate_collection == "YingYang Collection") then
                tbl2 = buffCrate(crate_collection, 10)
            end
