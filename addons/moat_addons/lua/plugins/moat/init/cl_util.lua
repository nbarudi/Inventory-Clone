...
local function fetch_image(crc, url)
	if exists("gritsky_assets/" .. crc .. ".png", "DATA") then
		assets[url] = Material("data/gritsky_assets/" .. crc .. ".png")
	...
	fetch(url, function(data)
		write("gritsky_assets/" .. crc .. ".png", data)
		assets[url] = Material("data/gritsky_assets/" .. crc .. ".png")
	end)
...
local function fetch_sound(crc, url)
	if exists("gritsky_assets/" .. crc .. ".txt", "DATA") then
		assets[url] = "data/gritsky_assets/" .. crc .. ".txt"
...
local function write_sound(crc, url)
	fetch(url, function(data)
		write("gritsky_assets/" .. crc .. ".txt", data)
		assets[url] = "data/gritsky_assets/" .. crc .. ".txt"
	end)
end
