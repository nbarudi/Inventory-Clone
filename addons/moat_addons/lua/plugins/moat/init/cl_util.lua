file.CreateDir("bungottt_assets")
...
local function fetch_image(crc, url)
	if exists("bungottt_assets/" .. crc .. ".png", "DATA") then
		assets[url] = Material("data/bungottt_assets/" .. crc .. ".png")
	...
	fetch(url, function(data)
		write("bungottt_assets/" .. crc .. ".png", data)
		assets[url] = Material("data/bungottt_assets/" .. crc .. ".png")
	end)
...
local function fetch_sound(crc, url)
	if exists("bungottt_assets/" .. crc .. ".txt", "DATA") then
 		assets[url] = "data/bungottt_assets/" .. crc .. ".txt"
...
local function write_sound(crc, url)
	fetch(url, function(data)
		write("bungottt_assets/" .. crc .. ".txt", data)
		assets[url] = "data/bungottt_assets/" .. crc .. ".txt"
	end)
end
...
local default_avatar = "https://tttweb.bungo.ca/public/ttt/misc/jarvis_ava_fire.png"
