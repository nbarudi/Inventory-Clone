...
moat.Ranks.Register(9, "developer", "Developer")
	:SetWeight(80)
	:ForumSync(12)
	:SetColor {0, 188, 212}
...
moat.Ranks.Register(10, "headadmin", "Head Administrator")
	:SetWeight(85)
	:ForumSync(13)
	:SetColor {255, 51, 148}
	:SetIcon "icon16/wand.png"
...
moat.Ranks.Register(12, "owner", "owner")
	:SetWeight(100)
	:ForumSync(25)
	:SetColor {255, 51, 51}
...
moat.Ranks.Register(13, "techartist", "Technical Artist")
	:SetWeight(35)
	:ForumSync(26)
	:SetColor {255, 51, 51}
...
moat.Ranks.Register(14, "audioengineer", "Audio Engineer")
	:SetWeight(35)
	:ForumSync(27)
	:SetColor {255, 51, 51}
...
moat.Ranks.Register(15, "softwareengineer", "Software Engineer")
	:SetWeight(35)
	:ForumSync(28)
	:SetColor {255, 51, 51}
	:SetIcon "icon16/application_osx_terminal.png"
...
moat.Ranks.Register(16, "gamedesigner", "Game Designer")
	:SetWeight(35)
	:ForumSync(29)
	:SetColor {255, 51, 51}
...
moat.Ranks.Register(17, "creativedirector", "Creative Director")
	:SetWeight(35)
	:ForumSync(30)
	:SetColor {255, 51, 51}
