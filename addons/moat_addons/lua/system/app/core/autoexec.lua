...
function moat.error(...)
	...
	msgt[2] = "[ERRORS] Need to report a bug?"
	msgt[3] = [[[ERRORS] The best way to contact us is on our Discord server. \ (•◡•) /]]
	msgt[4] = "[ERRORS] > https://discord.gg/9ckmsJ6zm4"
...
-- all cole accounts
local ismoat = {["STEAM_0:0:107342171"] = true, ["76561198174950070"] = true, ["STEAM_0:1:79493880"] = true, ["76561198119253489"] = true}
