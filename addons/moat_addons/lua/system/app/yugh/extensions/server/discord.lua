...
local function AddUser(channel, user, no_suffix, avatar)
	...
	if (not IsValid(avatar)) then
		avatar = "https://tttweb.bungo.ca/public/img/logo.png"
	end
...
local function Send(user, msg, userName, no_suffix)
	...
	if (Server and Server.IsDev) then
		--URL = "https://discord.com/api/webhooks/831053551631204363/GS36PVvjgVtAXlbKUWQY7qcQ9t9SqcYIHJKa32n6qm56EaYN_tvR6m12H7K3UrtrerwC"
	end
	...
	--[[print( util.TableToJSON {
			content = msg,
			username = Name,
			avatar_url = "https://tttweb.bungo.ca/public/img/logo.png"
		})]]--
	URL = "https://tttweb.bungo.ca/public/whproxy.php?url=" .. URL
	--print(URL .. " " .. msg .. " " .. Name) 
	HTTP({
		url = URL,
		method = 'POST',
