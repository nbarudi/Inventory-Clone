...
function PANEL:Paint()
   ...
   surface_DrawRect(0, 0, w, h)]]
	cdn.DrawImage("https://tttweb.bungo.ca/public/ttt/server_bg.png", math.min((w/2) - (3840/2), 0), math.min((h/2) - (2160/2), 0), math.max(3840, h), math.max(2160, w), Color(255, 255, 255, 230))	
